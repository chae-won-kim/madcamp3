...
public class MicrophoneCapture : MonoBehaviour
{
	...
	public void StopListening()
	{
		if (recordingActive)
		{
			...
			StartCoroutine(StartVoiceRequest("https://dialogflow.googleapis.com/v2/projects/simsim-oyqqfs/agent/sessions/34563:detectIntent",
				"ya29.c.Kl65BwhDXOQLm8abeb-ctD8N4TTeHSWO6DdjvQNTDbjA4a_vkIL0dfM5D6u1bwpjL3ecbmvx_3ZIUxHfKXKzRaTrxveCNq_HAsMsnFpw7bCExFzVyJT4HwCb9VD-mU63",
				bytes));
		}
	}
